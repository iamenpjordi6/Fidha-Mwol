...
module.exports = {
    ...
    GANSTYLE: process.env.GAN_IMAGE === undefined ? 'https://telegra.ph/file/afd4937c734fb2db0a8c8.jpg' : process.env.GAN_IMAGE,
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By MilfBOT' : process.env.ALL_CAPTION,
    AFNN: process.env.TAG_REPLY === undefined ? '917428849575@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    BOT: process.env.BOT_NAME === undefined ? 'MilfBOT' : process.env.BOT_NAME,
